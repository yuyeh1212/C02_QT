...
const ReservationModal = ({ show, onClose }) => {
    const[notices] = useState([
        ...
        {
          numbering:2,
          content:"施作需2.5～4小時（依施作項目而定），預約前請事先評估預留足夠時間，趕時間的人請斟酌預約。"
        }
        ,
        {
          numbering:3,
        ...
        {
          numbering:5,
          content:"請確定好日期及時間再預約，若要取消、更改時段請於3天前告知。"
        }
        ,
        {
          numbering:6,
        ...
        <div className={`modal fade ${show ? 'show d-block' : ''}`} tabIndex="-1" role="dialog" style={{ backgroundColor: 'rgba(0, 0, 0, 0.5)' ,zIndex:999}}>
            <div className="modal-dialog modal-dialog-centered" role="document" style={{ height: '100vh', display: 'flex', alignItems: 'center' }}>
                <div className="modal-content text-center" style={{ border: '2px solid #BF9958', height: '90vh' }}>
                    ...
                    <div className="modal-body py-4" style={{ height: '80vh', overflowY: 'auto' }}>
                    ...
                    <div className="modal-footer justify-content-center border-0">
                        <button
                            type="button"
                            className="btn"
                            style={{ backgroundColor: '#BF9958', color: 'white', padding: '0.5rem 2rem', borderRadius: '2rem' }}
                            onClick={onClose}
                        >
                            確認
                        </button>
