  ...
  const [notices] = useState([
    {
      numbering: 1,
      content:
        '這裡有一隻臘腸狗和一隻肥橘貓，腸腸有分離焦慮，都會跟在腳邊，他心情好會跟你sayHI（汪），事先做好心理準備，請不用害怕。如果會擔心接觸他們，可事先告知，會安置在推車內，與您保持友善距離。',
    },
    {
      numbering: 2,
      content:
        '施作需2.5～4小時（依施作項目而定），預約前請事先評估預留足夠時間，趕時間的人請斟酌預約。',
    },
    {
      numbering: 3,
    ...
    {
      numbering: 5,
      content: '請確定好日期及時間再做預約，若要取消、更改時段請於3天前告知。',
    },
    {
      numbering: 6,
    ...
    },
    {
      numbering: 12,
      content:
        '美甲屬於1對1個人服務，一定會在溝通確定後才施作，服務後無提供免費卸甲及不滿意退費機制。',
    },
    {
      numbering: 13,
      ...
      <div className="bg-neutral-100 overflow-x-hidden">
        <section className="container ">
          <div className="py-5 py-md-13 mx-auto">
            <h2 className="fs-6 fs-md-7 text-primary-02 text-center mb-4 fw-semibold fw-md-bold">
              預約須知
            </h2>
            <div className="py-3 px-5 text-primary fs-md-4 bg-neutral-200 text-center mb-6 mb-md-11 mx-auto">
              預約諮詢請加Line@：@893ukbbx
            </div>
            <div className="row justify-content-end mb-6 mb-md-11 ">
              {windowWidth < 992 ? (
                <div className="mb-5">
                  <img
                    ...
                    style={{
                      ...
                      objectFit: 'cover',
                      maxHeight: windowWidth < 576 ? 248 : windowWidth < 768 ? 344 : 464,
                    }}
                  />
                </div>
              ) : (
                <div className="col-lg-6 position-relative">
                  <div
                    className=" overflow-hidden position-absolute h-100"
                    style={{ borderTopRightRadius: 64, width: 868, right: 100 }}
                  >
                    <img className="h-100 w-100" src="26544.jpg" alt="img-Notice" />
                  </div>
                </div>
              )}
            ...
            <h3 className="fs-3 fs-md-5 text-primary-02 text-center">
              詳細閱讀後預約代表同意以上條款
            </h3>
          </div>
        </section>
      ...
      <div className="bg-neutral-200 overflow-x-hidden">
        <section className="container ">
          <div className="py-6 py-md-13 mx-auto">
            <h2 className="fs-6 fs-md-7 text-primary-02 text-center mb-4 fw-semibold fw-md-bold mb-6 mb-md-11">
              價目表 Price
            </h2>
            <div className="row">
              <div className="col-lg-6">
                <table
                  className="table table-spacing-sm table-borderless table-neutral-200 mb-2 text-primary-02"
                  style={{ marginLeft: -4 }}
                >
                  <thead>
                    <tr className="fs-md-5 fw-bold">
                      <th scope="col" style={{ minWidth: 180, maxWidth: 324 }}>
                        凝膠項目
                      </th>
                      <th scope="col">手部</th>
                      <th scope="col">足部</th>
                  ...
                  <tbody className="fs-md-4 fw-md-medium">
                    ...
                    <tr>
                      <td colSpan={3} className="py-4 px-0">
                        <div
                          style={{ backgroundColor: 'var(--bs-secondary-200)', height: '1px' }}
                        ></div>
                      </td>
                    </tr>
                    <tr>
                    ...
                    <tr className="text-primary-02 fs-md-5 fw-bold">
                      <th scope="col" style={{ minWidth: 180, maxWidth: 324 }}>
                        卸甲 <span className="fs-2 d-block d-md-inline">（手足同價）</span>
                      </th>
                      <th scope="col">本店</th>
                      <th scope="col">他店</th>
                    </tr>
              ...
              {windowWidth < 992 ? (
                ...
                <div className="col-lg-6 position-relative">
                  <div
                    className=" overflow-hidden position-absolute h-100"
                    style={{ borderTopLeftRadius: 64, width: 908, left: 100 }}
                  >
                    <img className="h-100 w-100" src="2149171334.jpg" alt="img-Price" />
                  </div>
                </div>
              )}
            </div>
            ...
            <div className="row align-items-center mb-6 mb-md-11">
              {windowWidth < 992 ? (
                ...
                <div className="col-lg-6 position-relative" style={{ minHeight: 574 }}>
                  <div
                    className=" overflow-hidden position-absolute h-100"
                    style={{ borderTopRightRadius: 64, width: 956, minHeight: 574, right: 100 }}
                  >
                    <img className="h-100 w-100" src="2149975490.jpg" alt="img-Notes" />
                  </div>
                </div>
              )}
              <div className="col-lg-6 ">
                ...
                <div className="d-flex align-items-start mb-4">
                  ...
                  <p className="fs-2 fs-md-4 text-primary-02">
                    基礎保養含修剪甲型、甘皮、兩側硬皮、硬甲油塗佈及指緣油保養。
                  </p>
                </div>
                <div className="d-flex align-items-start mb-4">
                  <div className="px-1 me-4" style={{ paddingTop: 2 }}>
                  ...
                  <p className="fs-2 fs-md-4 text-primary-02">純卸甲均不含保養，可另外加購保養。</p>
                </div>
                <div className="d-flex align-items-start">
                  <div className="px-1 me-4" style={{ paddingTop: 2 }}>
                    <span className="number-box">4</span>
                  </div>
