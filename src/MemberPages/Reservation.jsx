    ...
    <div className="bg-neutral-100  py-md-15 py-4">
      <div className="container">
        ...
        <div className="row flex-lg-row-reverse">
          <div
            className={`col-lg-9 ps-lg-4 pb-4 pb-lg-0 ${windowSize < 992 ? (windowSize < 768 ? '' : 'bg-white') : 'bg-neutral-100'}`}
          >
            {windowSize > 991 ? (
              <div className="bg-white">
                <MyCalendar
                  ...
                  filterEventsByMonth={filterEventsByMonth}
                />
              </div>
            ) : (
              ''
          ...
          <div
            className={`col-lg-3 ${windowSize < 768 ? '' : 'bg-white'} p-4`}
            ...
            <form id="makeAnAppointment" onSubmit={handleSubmit(onSubmit)}>
              <div className="mb-4">
                ...
                <input
                  ...
                  id="renderDate"
                  placeholder={`${windowSize < 768 ? '點擊時段選擇預約時間' : '點擊月曆選擇預約時間'}`}
                  disabled
                  {...register('renderDate', {
                    required: { value: true, message: '請確認預約時段' },
                  })}
                />
                {errors.renderDate && (
              ...
              <div className="mb-4">
                ...
                <select
                  className={`form-select form-select-sm ${errors.bodyPart ? 'is-invalid' : ''}`}
                  id="bodyPart"
                  defaultValue=""
                  {...register('bodyPart', {
                    required: { value: true, message: '請選擇施作部位' },
                  })}
                >
              ...
              <div className="mb-4">
                ...
                <select
                  className={`form-select form-select-sm ${errors.nailRemoval ? 'is-invalid' : ''}`}
                  id="nailRemoval"
                  defaultValue=""
                  {...register('nailRemoval', {
                    required: { value: true, message: '請選擇是否需要卸甲' },
                  })}
                >
                  <option value="" disabled>
                    請選擇是否需要卸甲
              ...
              <div className="mb-4">
                ...
                <select
                  className={`form-select form-select-sm ${errors.nailExtension ? 'is-invalid' : ''}`}
                  id="nailExtension"
                  defaultValue=""
                  {...register('nailExtension', {
                    required: { value: true, message: '請選擇是否需要延甲' },
                  })}
                >
      ...
      {
        <ReservationModal
          show={reservationAlertState.show}
          onClose={() => setReservationAlertState({ show: false })}
        ></ReservationModal>
      }
    </div>
  );
